...
// Heap be used when calculate minimum/maximum, HeapSort, construct priority queue or graph algorithms(Prim's / Dijkstra..)
...
/// When sort is '<', it is MinHeap. In contrast, '>' is MaxHeap
///
/// Time Complexity:
///
